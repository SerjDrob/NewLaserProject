...
namespace NewLaserProject.Migrations
{
    ...
    [Migration("20240405082119_AddCreatedAndAlteredDateTechnology")]
    partial class AddCreatedAndAlteredDateTechnology
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewLaserProject.Data.Models.MaterialEntRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("NewLaserProject.Data.Models.MaterialEntRule", b =>
                {
                    b.HasOne("NewLaserProject.Data.Models.Material", "Material")
                        .WithOne("MaterialEntRule")
                        .HasForeignKey("NewLaserProject.Data.Models.MaterialEntRule", "MaterialId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
